...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/ExponentialNoError.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/EIP20Interface.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/ErrorReporter.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/EIP20NonStandardInterface.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/InterestRateModel.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/ComptrollerInterface.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/CTokenInterfaces.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/CToken.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/PriceOracle.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/ComptrollerStorage.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/Unitroller.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/IETCswapV3Oracle.sol
...
// File: NYKE PROTOCOL - Comptroller with Oracle/contracts/Comptroller.sol
...
contract Comptroller is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    IETCswapV3Oracle public ETCswapV3Oracle;
    ...
    constructor() {
        admin = msg.sender;
        address OracleContract = 0xc4437E60C41D25809BB968A02c4036DAB4AC99Fe;
    }
    ...
    function borrowAllowed(address cToken, address borrower, uint borrowAmount) override external returns (uint) {
        ...
        if (IETCswapV3Oracle(OracleContract).GetUnderlyingPrice(cToken) == 0) {
     ...
     * @param cToken The market to hypothetically redeem/borrow in
    ...
    function getHypotheticalAccountLiquidity(
        ...
        (Error err, uint liquidity, uint shortfall) = getHypotheticalAccountLiquidityInternal(account, CToken(cToken), redeemTokens, borrowAmount);
        return (uint(err), liquidity, shortfall);
    }
    ...
    function getHypotheticalAccountLiquidityInternal(
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            address CTokenAddy = address(asset);
            ...
            vars.oraclePriceMantissa = IETCswapV3Oracle(OracleContract).GetUnderlyingPrice(CTokenAddy);
    ...
    function liquidateCalculateSeizeTokens(address cTokenBorrowed, address cTokenCollateral, uint actualRepayAmount) override external view returns (uint, uint) {
        ...
        uint priceBorrowedMantissa = IETCswapV3Oracle(OracleContract).GetUnderlyingPrice(cTokenBorrowed);
        uint priceCollateralMantissa = IETCswapV3Oracle(OracleContract).GetUnderlyingPrice(cTokenCollateral);
    ...
    function _setCollateralFactor(address cToken, uint newCollateralFactorMantissa) external returns (uint) {
        ...
        if (newCollateralFactorMantissa != 0 && IETCswapV3Oracle(OracleContract).GetUnderlyingPrice(cToken) == 0) {
    ...
    function setNykeAddress(address NykeToken) public {
         require(adminOrInitializing(), "only admin can set Nyke Token");
         NykeAddress = NykeToken;
    }
